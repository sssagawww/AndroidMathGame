...
public class RhythmMenu extends Table {
    private final Table strengthTable;
    private final Image playerImage;
    private final Drawable finalSword;
    private final ArrayList<TextureRegionDrawable> drawables;
    private ProgressBar strengthBar;
    private ProgressBar progressBar;
    private final Label strengthLabel;
    private final Label percentsLabel;
    ...
    private final float playerImageSize;
    ...
    private void createBars() {
        ...
        strengthBarStyle.background.setMinWidth(Gdx.graphics.getWidth()/20f);
        strengthBarStyle.knobBefore = getSkin().getDrawable("green");
        strengthBarStyle.knobBefore.setMinWidth(Gdx.graphics.getWidth()/23f);
        ...
        progressBarStyle.background.setMinHeight(Gdx.graphics.getHeight()/20f);
        progressBarStyle.knobBefore = getSkin().getDrawable("prLine");
        progressBarStyle.knobBefore.setMinHeight(Gdx.graphics.getHeight()/28f);
