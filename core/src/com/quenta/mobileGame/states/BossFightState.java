...
import static com.quenta.mobileGame.MyGdxGame.PREF_DUNGEON;
import static com.quenta.mobileGame.MyGdxGame.PREF_FOREST;
import static com.quenta.mobileGame.MyGdxGame.PREF_MAZE;
import static com.quenta.mobileGame.MyGdxGame.PREF_MAZE_HOODED;
import static com.quenta.mobileGame.MyGdxGame.PREF_STATE;
...
import static com.quenta.mobileGame.handlers.GameStateManager.BLACK_SCREEN;
import static com.quenta.mobileGame.handlers.GameStateManager.BOSSFIGHT;
...
import com.quenta.mobileGame.UI.BossLabel;
...
import com.quenta.mobileGame.entities.SlimeBoss;
...
public class BossFightState extends GameState implements Controllable {
    ...
    private final BoundedCamera bossCam;
    ...
    public BossFightState(GameStateManager gsm) {
        super(gsm);
        music = Gdx.audio.newMusic(Gdx.files.internal("music/Lastfight.mp3"));
...
//        entities.render(sb, 1.5f, 1.5f);
    ...
    private void createTiles() {
        TiledMap tiledMap = new TmxMapLoader().load("sprites/mystic_woods_free_2.1/bosslocation2.tmx");
    ...
    private void createPlayer() {
        ...
        if(MyGdxGame.getPrefs().getInteger(PREF_STATE, NEW_GAME) == BOSSFIGHT){
            bdef.position.x = MyGdxGame.getPrefs().getFloat(PREF_X, 1000f / PPM);
            bdef.position.y = MyGdxGame.getPrefs().getFloat(PREF_Y, 150f / PPM);
        }  else {
            bdef.position.set(1000f / PPM, 150f / PPM);
        }

        MazeState.progress = MyGdxGame.getPrefs().getBoolean(PREF_MAZE, false);
        MazeState.hoodedRun = MyGdxGame.getPrefs().getBoolean(PREF_MAZE_HOODED, false);
        Forest.progress = MyGdxGame.getPrefs().getBoolean(PREF_FOREST, false);
        DungeonState.progress = MyGdxGame.getPrefs().getBoolean(PREF_DUNGEON, false);
    ...
    private void initFight() {
        ...
        OptionBox2 optionBox = new OptionBox2(skin_this);
