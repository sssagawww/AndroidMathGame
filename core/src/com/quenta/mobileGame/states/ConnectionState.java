...
import static com.quenta.mobileGame.MyGdxGame.PREF_ID;
...
import com.quenta.mobileGame.UI.ConnectionMenu;
...
public class ConnectionState extends GameState {
    ...
    private void init() {
        ...
        root.add(menuImg).align(Align.topLeft).width(Gdx.graphics.getHeight() / 9f).height(Gdx.graphics.getHeight() / 9f);
