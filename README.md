...
3. Ввести имя игрока и нажать на зелёную галочку (подтвердить ввод)
4. Если всё хорошо, то айпи останется в поле ввода, иначе - сотрётся, и его нужно будет ввести ещё раз и нажать снова на галочку
5. Далее можно выбрать режим
6. В самом режиме нужно нажать на кнопку готовности, дождаться 2 игрока и начать игру
